  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
        return auctionInstance.bid(1, 5, {from:accounts[1]})/*<CODE HERE>*/
    }).then(function() {
      /**********
      ...
      ***********/
        return auctionInstance.getPersonDetails(0, {from:accounts[0]})/*<CODE HERE>*/
    }).then(function(result) {
      /**********
      ...
      ***********/
     assert.notEqual(winners[0], '0x0000000000000000000000000000000000000000', "winner address is not default address")
      /*<CODE HERE>*/
      /**********
      TASK 16: call winners function from accounts[0] to get the winner of item id 1
      ***********/
      return auctionInstance.getPersonDetails(1, {from:accounts[0]})/*<CODE HERE>*/
    }).then(function(result) {
      /**********
      ...
      ***********/
      return auctionInstance.getPersonDetails(2, {from:accounts[3]})/*<CODE HERE>*/
    }).then(function(result) {
      /**********
